  ...
  return (
    <>
      ...
      <div className='flex flex-col relative'>
        <div className="search flex w-[500px] h-[48px] search-mob p-2 border-[1.5px] border-[#e6ebee] justify-center items-center gap-1 rounded-xl shadow-lg shadow-[#30323316]">
        ...
        {isExpanded && (
          <div className=" z-50 overflow-hidden absolute top-[47px] flex flex-col text-sm text-[#9a9a9a] w-full  bg-[#fff] recent-searches border-[1.5px] border-[#e6ebee] justify-start items-center rounded-xl shadow-lg shadow-[#30323316]">
            ...
            {recentSearches.length === 0 ? (
              ...
              <>
                <div className=' text-start w-full overflow-hidden px-2 pt-2'>Recent Searches</div>
