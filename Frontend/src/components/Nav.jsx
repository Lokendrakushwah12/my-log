                ...
                <div className="w-[200px] overflow-hidden h-screen p-3 border-r flex flex-col justify-between" >
                    ...
                    <div className="flex items-start gap-12 flex-col w-[180px]">
                        ...
                        <div className="flex flex-col gap-[6px] items-start justify-center">
                            <div onClick={() => setOpenCreateTodo(true)} className="flex flex-row items-center gap-4 w-[180px] p-3 rounded hover:bg-[#edeeef] active:bg-[#edeeef] cursor-pointer">
                            ...
                            <NavLink to="/tasks" activeClassName="active">
                                <div className="flex flex-row items-center gap-4 w-[180px] p-3 rounded hover:bg-[#edeeef] active:bg-[#edeeef] cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <div className="flex items-start gap-12 flex-col w-[180px]">
                        ...
                        <div className="flex items-center w-[180px] justify-between rounded p-[5px] bg-[#edeeef] act cursor-pointer">
