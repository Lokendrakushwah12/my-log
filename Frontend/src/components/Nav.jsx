    ...
    return (
        <>
            ...
            <div className="fixed top-0 left-0">
                ...
                <div className="w-[200px] width-100 overflow-hidden h-screen p-3 border-r flex flex-col justify-between" >
                    {/* top part */}
                    <div className="flex items-start centers gap-12 flex-col w-full">
                        <div className="head flex flex-row gap-[6px] p-3">
                            <Link to="/" >
                                <div className="flex items-center justify-center gap-2 cursor-pointer">
                                    ...
                                    <h1 className='font-semibold text-2xl text-[#2B2B2B] hide'>ml</h1>
                                </div>
                            </Link>
                        </div>
                        <div className="flex flex-col gap-[6px] items-start justify-center">
                            <div onClick={() => setOpenCreateTodo(true)} className="flex flex-row items-center gap-4 w-full p-3 rounded-md hover:bg-[#edeeef] active:bg-[#edeeef] cursor-pointer">
                                ...
                                <h2 className='font-medium text-[20px] text-[#2B2B2B] hide'>Create log</h2>
                            </div>
                            <NavLink to="/tasks" activeClassName="active">
                                <div className="flex flex-row items-center gap-4 w-[159px] with p-3 rounded-md hover:bg-[#edeeef] active:bg-[#edeeef] cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    ...
                                    <h2 className='font-medium text-[20px] text-[#2B2B2B] hide'>Task</h2>
                                </div>
                            </NavLink>
                            <NavLink to="/completed" activeClassName="active">
                                <div className="flex flex-row items-center gap-4 w-full p-3 rounded-md hover:bg-[#edeeef] active:bg-[#edeeef] cursor-pointer">
                                    ...
                                    <h2 className='font-medium text-[20px] text-[#2B2B2B] hide'>Completed</h2>
                                </div>
                            </NavLink>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-12 flex-col w-full">
                        <div className="flex flex-col gap-[6px] items-start justify-center">
                            <div className="flex flex-row items-center gap-4  w-[175px] p-3 rounded-md hover:bg-[#edeeef] active:bg-[#edeeef] cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                ...
                                <h2 className='font-medium text-[20px] text-[#2B2B2B] hide'>Settings</h2>
                            </div>
                            <div className="flex flex-row items-center gap-4  w-[175px] p-3 rounded-md hover:bg-[#edeeef] active:bg-[#edeeef] cursor-pointer">
                                ...
                                <h2 className='font-medium text-[20px] text-[#2B2B2B] hide'>Support</h2>
                            </div>
                        </div>
                        <div className="flex items-center w-full justify-between rounded p-[5px] bg-[#edeeef] act cursor-pointer">
                            <img src={Avatar} alt="avatar" />
                            <div className="flex flex-col w-[130px]">
                                <h1 className='font-semibold text-[18px] text-[#2B2B2B] hide'>Bulma</h1>
                                <h6 className='font-normal text-[12px] text-[#878EA6] hide'>bulma@gmail.com</h6>
                            </div>
                        </div>
                    </div>
                </div>
