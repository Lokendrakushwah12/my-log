...
const Card = ({ todo, index, updateTodos, bg }) => {
    ...
    return (
        <>
            <div id={index} className="relative py-1">
                <div className="hover:cursor-grab absolute w-[16px] border-r-0 h-[120px] -left-4 top-[15px] rounded-tl-lg rounded-bl-lg bg-[#f0f3f5] border  shadow-md shadow-[#00000006] ">
                ...
                <div className={`flex w-[300px] h-[150px]  p-2 items-start gap-[10px] ${bg} rounded-xl shadow-lg shadow-[#00000010] border-[2px] border-[#ffffff50]`}>
