        ...
        <>
            <div className="flex w-[300px] p-3 items-start gap-[10px] bg-[#CEDDFC] rounded-xl shadow-md shadow-[#00000010] border-[2px] border-[#ffffff50]">
                <div className="flex flex-col items-start gap-[10px]">
                    <h2 className='font-medium text-[20px] text-[#2B2B2B]'>{props.head }</h2>
                    {/* heading of to do */}
                    
                    <h4 className='font-normal text-[14px] text-[#000] opacity-70'>Deadline: {props.deadline}</h4>
                </div>
                <div className="flex flex-col justify-between h-full items-start">
                    ...
                    <svg onClick={deleteTodo} className='cursor-pointer fill-opacity-50' xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
