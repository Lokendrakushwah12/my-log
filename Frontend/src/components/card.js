...
const Card = ({ todo, index, updateTodos }) => {
    ...
    return (
        <>
            <div id={index} className="relative">
                ...
                <div key={index} className={`flex w-[300px] h-[150px]  p-2 items-start gap-[10px] ${getRandomColor()} rounded-xl shadow-md shadow-[#00000010] border-[2px] border-[#ffffff50]`}>
